...
const pb_field_t sensors_fields[18] = {
    ...
    PB_FIELD( 15, SINT32  , OPTIONAL, STATIC  , OTHER, sensors, longitude, pir, 0),
    PB_FIELD( 16, SINT32  , OPTIONAL, STATIC  , OTHER, sensors, latitude, longitude, 0),
    PB_FIELD( 17, INT32   , OPTIONAL, STATIC  , OTHER, sensors, height, latitude, 0),
    PB_LAST_FIELD
};
